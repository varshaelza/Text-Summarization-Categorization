...
Original file is located at
    https://colab.research.google.com/drive/11XsdSh2Q_F4ySjwJesaP9BiZqgtAQS5F
"""
...
#import pandas as pd
#train = pd.read_csv('/content/drive/MyDrive/BBC Dataset/LDA Summarization/LDASummariestest.csv')
#train['Summary3.1(Imp)']=""
#train['Length3.1(Imp)']=0
#i=0
...
def getsummary(text):
  ...
  dup=dup.drop_duplicates( subset=['Sentence'], keep="first", inplace=False)
  dup.sort_values(by=['Topic','Perc_Contribution'],inplace=True,ascending=False)
  dup=dup.drop_duplicates( subset=['Topic'], keep="first", inplace=False)
  dup.sort_values(by=['Perc_Contribution'],inplace=True,ascending=False)
  #dup=dup.drop_duplicates( subset=['Sentence'], keep="first", inplace=False)
  ...
  #train['Summary3.1(Imp)'][i]=s
  #train['Length3.1(Imp)'][i]=lg
  #i=i+1
  return s